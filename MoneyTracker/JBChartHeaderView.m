...
+ (void)initialize
{
	...
	{
		kJBChartHeaderViewDefaultSeparatorColor = [UIColor greenColor];
	}
}
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _titleLabel.font = [UIFont fontWithName:@"HelveticaNeue-Thin" size:32.0f];
        ...
        _subtitleLabel.font = [UIFont fontWithName:@"HelveticaNeue-Thin" size:32.0f];
        ...
        _separatorView.backgroundColor = [UIColor greenColor];
