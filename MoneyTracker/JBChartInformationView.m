...
+ (void)initialize
{
	...
	{
		kJBChartViewSeparatorColor = [UIColor greenColor];
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _valueLabel.font = [UIFont fontWithName:@"HelveticaNeue-Thin" size:32.0f];
        ...
        _unitLabel.font = [UIFont fontWithName:@"HelveticaNeue-Thin" size:32.0f];
